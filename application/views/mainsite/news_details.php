<div class="content"><div class="ic"></div>
    <div class="container_12">
        <div class="grid_6">
            <?php
            ?>
            <h2> &nbsp;&nbsp;&nbsp;<?php echo $news_details->news_title; ?></h2>
            <h6> &nbsp;&nbsp;&nbsp; Published on <?php echo $news_details->news_publication_date; ?></h6>
            <br><br>

            <img style="width: 110px; height: 110px;" src="<?php echo base_url() . $news_details->news_image; ?>" alt="" class="img_inner fleft">
            <!--<div class="extra_wrapper">-->
                <p class="col2" align="justify"><?php echo $news_details->news_long_description; ?></p>
