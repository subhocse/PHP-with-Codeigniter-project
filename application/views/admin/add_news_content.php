                    ...
                    <div class="row-fluid sortable">
                        <div class="box span12">
                            <div class="box-content">
                                <form class="form-horizontal" enctype="multipart/form-data" action="<?php echo base_url(); ?>super_admin/save_news" method="post" onsubmit="return validateStandard(this)">
                                    <fieldset>
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" class="span6 typeahead" id="typeahead" err="Enter a valide Title" data-provide="typeahead" data-items="4" name="news_title" required regexp="JSVAL_RX_ALPHA">
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <textarea name="news_short_description" placeholder="Type here" style='width: 48.3%'></textarea>
                                            </div>
                                        </div>
                                        <div class="control-group">
                                            <label class="control-label" for="textarea2">Long Description (<span style="color: red">*</span>)</label>
                                            <div class="controls">
                                                <textarea name="news_long_description" placeholder="Type here" style='width: 48.3%'></textarea>
                                            </div><br>
                                            <div class="control-group">
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" name="news_publication_date" class="span6 typeahead" id="typeahead" placeholder="Example: 2015-Jan-03" value="">
                                            </div>
                                        </div>
                                        <div class="control-group">
                                            <label class="control-label" for="date01">Publication Status (<span style="color: red">*</span>)</label>
                                            <div class="controls">
                                                <select name="news_publication_status" err="Please Select Publication Status" name="publication_status" required exclude=" ">
