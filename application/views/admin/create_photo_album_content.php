                    ...
                    <div class="row-fluid sortable">
                        <div class="box span12">
                            <div class="box-content">
                                <form class="form-horizontal" enctype="multipart/form-data" action="<?php echo base_url(); ?>super_admin/save_photo_album" method="post" onsubmit="return validateStandard(this)">
                                    <fieldset>
                                        <legend>Create Photo Album</legend>
                                        <?php
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" class="span6 typeahead" id="typeahead" err="Enter a valide Album Name" data-provide="typeahead" data-items="4" name="album_name" required regexp="JSVAL_RX_ALPHA">
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <select name="album_publication_status" err="Please Select Publication Status" name="publication_status" required exclude=" ">
