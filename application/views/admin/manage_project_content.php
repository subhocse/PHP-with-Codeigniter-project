                        ...
                        <div class="box span12">
                            ...
                            <div class="box-content">
                                <table class="table table-striped table-bordered bootstrap-datatable datatable">
                                    ...
                                    <tbody>
                                        <?php
                                        foreach ($all_project as $v_category) {
                                            ?>
                                            <tr>
                                                <td><?php echo $v_category->project_id; ?></td>
                                                <td class="center"><?php echo $v_category->project_title; ?></td>
                                                <td class="center">
                                                    <?php
                                                    if ($v_category->project_publication_status == 1) {
                                                        echo 'Published';
                                                    } else {
                                                        echo 'Un Published';
                                                    }
                                                ...
                                                <td class="center">
                                                    <?php
                                                    if ($v_category->project_publication_status == 0) {
                                                        ?>
                                                        <a class="btn btn-success" href="<?php echo base_url(); ?>super_admin/publish_project/<?php echo $v_category->project_id; ?>" title="Published">
                                                            <i class="icon-arrow-up icon-white"></i>  

                                                        </a> <?php
                                                    } else {
                                                        ?>
                                                        <a class="btn btn-danger" href="<?php echo base_url(); ?>super_admin/unpublish_project/<?php echo $v_category->project_id; ?>" title="Un Published">
                                                            <i class="icon-arrow-down icon-white"></i>  

                                                        </a>
                                                    <?php } ?>
                                                    <a class="btn btn-info" href="<?php echo base_url(); ?>super_admin/edit_project/<?php echo $v_category->project_id; ?>" title="Edit">
                                                        <i class="icon-edit icon-white"></i>  

                                                    </a>
                                                    <a class="btn btn-danger" href="<?php echo base_url(); ?>super_admin/delete_project/<?php echo $v_category->project_id; ?>" title="Delete" onclick="return check_delete()">
