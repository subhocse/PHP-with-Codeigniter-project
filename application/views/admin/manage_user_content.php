                                    ...
                                    <tbody>
                                        ...
                                        foreach ($all_user as $v_user) {
                                            ...
                                            <tr>
                                                ...
                                                <td class="center">
                                                    <a href="<?php echo base_url();?>super_admin/show_user_profile/<?php echo $v_user->user_id;?>">   <?php echo $v_user->user_first_name." ".$v_user->user_last_name; ?></a>
                                                </td>
                                                <td class="center">
                                                    <?php
                                                    if ($v_user->activation_status == 1) {
                                                        echo 'Activated';
                                                    } else {
                                                        echo 'Inactivated';
                                                    }
                                                ...
                                                <td class="center">
                                                    <?php
                                                    if ($v_user->activation_status == 0) {
                                                        ?>
                                                        <a class="btn btn-success" href="<?php echo base_url(); ?>super_admin/active_user/<?php echo $v_user->user_id;?>" title="Active">
                                                            <i class="icon-arrow-up icon-white"></i>  

                                                        </a> <?php
                                                    } else {
                                                        ?>
                                                        <a class="btn btn-danger" href="<?php echo base_url(); ?>super_admin/inactive_user/<?php echo $v_user->user_id;?>" title="Inactive">
                                                            <i class="icon-arrow-down icon-white"></i>  

                                                        </a>
                                                    <?php } ?>
                                                    <a class="btn btn-danger" href="<?php echo base_url();?>super_admin/delete_user/<?php echo $v_user->user_id;?>" title="Delete" onclick="return check_delete()">
