                        ...
                        <div class="box span12">
                            ...
                            <div class="box-content">
                                <table class="table table-striped table-bordered bootstrap-datatable datatable">
                                    ...
                                    <tbody>
                                            <tr>
                                                <td><?php echo $all_mission_info->mission_id; ?></td>
                                                <td class="center"><?php echo $all_mission_info->mission_title; ?></td>
                                                <td class="center">
                                                    <a class="btn btn-info" href="<?php echo base_url(); ?>super_admin/edit_mission/<?php echo $all_mission_info->mission_id; ?>" title="Edit">
