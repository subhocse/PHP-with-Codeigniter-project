...
<html class="lockscreen">
    ...
    <body>
        ...
        <div class="center">            
            ...
            <form  onclick="prevent_back()" action="<?php echo base_url(); ?>super_admin/check_password" method="post">
                <!-- User name -->
                <div class="lockscreen-name"><?php echo $this->session->userdata('full_name') ?></div>

                <!-- START LOCK SCREEN ITEM -->
                <div class="lockscreen-item">
                    <!-- lockscreen image -->
                    <div class="lockscreen-image">
                        <a href="<?php echo base_url() . $this->session->userdata('admin_photo_full'); ?>"><img style="width: 80px; height: 80px;" src="<?php echo base_url() . $this->session->userdata('admin_photo_thumb'); ?>" class="img-circle" alt="User Image" /></a>
                    ...
                    <div class="lockscreen-credentials">   
                        ...
                        <div class="input-group">
                            ...
                            <div class="input-group-btn">
                                <button type="submit" onclick="prevent_back()" class="btn btn-flat"><i class="fa fa-arrow-right text-muted"></i></button>
                            </div>
                        </div>
