...
<html lang="en">
                    ...
                    <div class="row-fluid sortable">
                        <div class="box span12">
                            <div class="box-content">
                                <form name="edit_events_content" class="form-horizontal" enctype="multipart/form-data" action="<?php echo base_url(); ?>super_admin/update_events" method="post" onsubmit="return validateStandard(this)">
                                    <fieldset>
                                        <legend>Edit events</legend>
                                        <div class="control-group">
                                            <label class="control-label" for="typeahead">events Title </label>
                                            <div class="controls">
                                                <input type="text" class="span6 typeahead" id="typeahead"  data-provide="typeahead" data-items="4" name="events_title" value="<?php echo $events_info->events_title; ?>">
                                                <input type="hidden" class="span6 typeahead" id="typeahead"  data-provide="typeahead" data-items="4" name="events_id" value="<?php echo $events_info->events_id; ?>">
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <textarea name="events_short_description" placeholder="Type here" style='width: 48.3%'><?php echo $events_info->events_short_description; ?></textarea>
                                            </div>
                                        </div>
                                        <div class="control-group">
                                            <label class="control-label" for="textarea2">Long Description</label>
                                            <div class="controls">
                                                <textarea name="events_long_description" placeholder="Type here" style='width: 48.3%'><?php echo $events_info->events_long_description; ?></textarea>
                                            </div><br>
                                            <?php
                                            if ($events_info->events_image) {
                                                ?>
                                                <div class="control-group">
                                                    <label class="control-label" for="fileInput"> Image</label>
                                                    <div class="controls">
                                                        <img style="width: 110px; height: 110px;" src="<?php echo base_url() . $events_info->events_image; ?>">
                                                        <a href="<?php echo base_url(); ?>super_admin/delete_events_image/<?php echo $events_info->events_id; ?>">delete image</a>
                                                    </div>
                                                </div>
                                            <?php } else { ?>
                                                <div class="control-group">
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" name="events_publication_date" class="span6 typeahead" id="typeahead" placeholder="Example: 2015-Jan-03" value="<?php echo $events_info->events_publication_date; ?>">
                                            </div>
                                        </div>
                                        <div class="control-group">
                                            <label class="control-label" for="date01">Publication Status</label>
                                            <div class="controls">
                                                <select name="events_publication_status" id="publication_status" err="Please Select Publication Status" required exclude=" ">
    ...
    <script type="text/javascript">
        document.forms['edit_events_content'].elements['publication_status'].value = '<?php echo $events_info->events_publication_status; ?>';
    </script>
    <!-- jQuery -->
