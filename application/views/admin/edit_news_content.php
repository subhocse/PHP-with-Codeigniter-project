                    ...
                    <div class="row-fluid sortable">
                        <div class="box span12">
                            <div class="box-content">
                                <form name="edit_news_content" class="form-horizontal" enctype="multipart/form-data" action="<?php echo base_url(); ?>super_admin/update_news" method="post" onsubmit="return validateStandard(this)">
                                    <fieldset>
                                        <legend>Edit News</legend>
                                        <div class="control-group">
                                            <label class="control-label" for="typeahead">News Title (<span style="color: red">*</span>) </label>
                                            <div class="controls">
                                                <input type="text" class="span6 typeahead" id="typeahead" err="Enter a News Title"  data-provide="typeahead" data-items="4" name="news_title" required regexp="JSVAL_RX_ALPHA" value="<?php echo $news_info->news_title; ?>">
                                                <input type="hidden" class="span6 typeahead" id="typeahead"  data-provide="typeahead" data-items="4" name="news_id" value="<?php echo $news_info->news_id; ?>">
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <textarea name="news_short_description" placeholder="Type here" style='width: 48.3%'><?php echo $news_info->news_short_description; ?></textarea>
                                            </div>
                                        </div>
                                        <div class="control-group">
                                            <label class="control-label" for="textarea2">Long Description</label>
                                            <div class="controls">
                                                <textarea name="news_long_description" placeholder="Type here" style='width: 48.3%'><?php echo $news_info->news_long_description; ?></textarea>
                                            </div><br>
                                            <?php
                                            if ($news_info->news_image) {
                                                ?>
                                                <div class="control-group">
                                                    <label class="control-label" for="fileInput"> Image</label>
                                                    <div class="controls">
                                                        <img style="width: 110px; height: 110px;" src="<?php echo base_url().$news_info->news_image;?>">
                                                        <a href="<?php echo base_url();?>super_admin/delete_news_image/<?php echo $news_info->news_id;?>">delete image</a>
                                                    </div>
                                                </div>
                                            <?php } else { ?>
                                                <div class="control-group">
                                                    ...
                                                    <div class="controls">
                                                        <input class="input-file uniform_on" id="fileInput" type="file" name="news_image">
                                                    </div>
                                                </div>
                                            <?php }?>
                                            </div>
                                            <div class="control-group">
                                                ...
                                                <div class="controls">
                                                    <input type="text" name="news_publication_date" class="span6 typeahead" id="typeahead" placeholder="Example: 2015-Jan-03" value="<?php echo $news_info->news_publication_date; ?>">
                                                </div>
                                            </div>
                                            <div class="control-group">
                                                <label class="control-label" for="date01">Publication Status</label>
                                                <div class="controls">
                                                    <select name="news_publication_status" id="publication_status" err="Please Select Publication Status" required exclude=" ">
