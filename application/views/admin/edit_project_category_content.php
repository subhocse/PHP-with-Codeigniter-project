...
<html lang="en">
                    ...
                    <div class="row-fluid sortable">
                        <div class="box span12">
                            ...
                            <div class="box-content">
                                <form name="edit_project_category_content" class="form-horizontal" enctype="multipart/form-data" action="<?php echo base_url(); ?>super_admin/update_project_category" method="post" onsubmit="return validateStandard(this)">
                                    <fieldset>
                                        <legend>Edit Project Category</legend>
                                        <div class="control-group">
                                            <label class="control-label" for="typeahead">Category Name (<span style="color: red">*</span>)</label>
                                            <div class="controls">
                                                <input type="text" class="span6 typeahead" id="typeahead" err="Enter a valid Category Name" data-provide="typeahead" data-items="4" name="project_category_name" required regexp="JSVAL_RX_ALPHA" value="<?php echo $project_category_info->project_category_name; ?>">
                                                <input type="hidden" class="span6 typeahead" id="typeahead"  data-provide="typeahead" data-items="4" name="project_category_id" value="<?php echo $project_category_info->project_category_id; ?>">
                                            </div>
                                        </div>
                                        <div class="control-group">
                                            <label class="control-label" for="textarea2">Category Description</label>
                                            <div class="controls">
                                                <textarea name="project_category_description" style='width: 48.3%'></textarea>

                                            </div><br>
                                            <?php
                                            if ($project_category_info->project_category_image) {
                                                ?>
                                                <div class="control-group">
                                                    <label class="control-label" for="fileInput"> Image</label>
                                                    <div class="controls">
                                                        <img style="width: 110px; height: 110px;" src="<?php echo base_url() . $project_category_info->project_category_image; ?>">
                                                        <a href="<?php echo base_url(); ?>super_admin/delete_project_category_image/<?php echo $project_category_info->project_category_id; ?>">delete image</a>
                                                    </div>
                                                </div>
                                            <?php } else { ?>
                                                <div class="control-group">
                                                    ...
                                                    <div class="controls">
                                                        <input class="input-file uniform_on" id="fileInput" type="file" name="project_category_image">
                                                    </div>
                                                </div>
                                            <?php } ?>
                                        </div>
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <select name="project_category_publication_status" err="Please Select Publication Status"  required exclude=" ">
    ...
    <script type="text/javascript">
        document.forms['edit_project_category_content'].elements['project_category_publication_status'].value = '<?php echo $project_category_info->project_category_publication_status; ?>';
    </script>
    <!-- jQuery -->
