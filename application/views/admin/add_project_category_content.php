                    ...
                    <div class="row-fluid sortable">
                        <div class="box span12">
                            ...
                            <div class="box-content">
                                <form class="form-horizontal" enctype="multipart/form-data" action="<?php echo base_url(); ?>super_admin/save_project_category" method="post" onsubmit="return validateStandard(this)">
                                    <fieldset>
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" class="span6 typeahead" id="typeahead" err="Enter a valid Category Name" data-provide="typeahead" data-items="4" name="project_category_name" required regexp="JSVAL_RX_ALPHA">
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <select name="project_category_publication_status" err="Please Select Publication Status" name="publication_status" required exclude=" ">
