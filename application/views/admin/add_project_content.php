                    ...
                    <div class="row-fluid sortable">
                        <div class="box span12">
                            <div class="box-content">
                                <form class="form-horizontal" enctype="multipart/form-data" action="<?php echo base_url(); ?>super_admin/save_project" method="post" onsubmit="return validateStandard(this)">
                                    <fieldset>
                                        ...
                                        <div class="control-group">
                                            <label class="control-label" for="typeahead">Project Title </label>
                                            <div class="controls">
                                                <input type="text" class="span6 typeahead" id="typeahead"  err="Please enter a valid Project Title" data-provide="typeahead" data-items="4" name="project_title" required regexp="JSVAL_RX_ALPHA">
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <select name="project_category_id" required exclude=" " err="Please Select Project Category">
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <textarea name="project_short_description" style='width: 48.3%'></textarea>
                                            </div>
                                        </div>
                                        <div class="control-group">
                                            <label class="control-label" for="textarea2">Long Description</label>
                                            <div class="controls">
                                                <textarea name="project_long_description" style='width: 48.3%'></textarea>
                                            </div><br>
                                            <div class="control-group">
                                                <label class="control-label" for="date01">Publication Date</label>
                                                <div class="controls">
                                                    <input type="text" class="span6 typeahead" id="typeahead" name="project_date" required="">
                                                </div>
                                            </div>
                                            <br>
                                            <div class="control-group">
