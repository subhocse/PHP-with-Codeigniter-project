...
<html lang="en">
        ...
        <aside class="right-side">                
            ...
            <section class="content-header">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="active">Edit Photo Info</li>
                </ol>
            </section>
                    ...
                    <div class="row-fluid sortable">
                        <div class="box span12">
                            <div class="box-content">
                                <form name="update_photo_info_content" class="form-horizontal" enctype="multipart/form-data" action="<?php echo base_url(); ?>super_admin/update_photo_info" method="post" onsubmit="return validateStandard(this)">
                                    <fieldset>
                                        <legend>Edit Photo Info</legend>
                                        <div class="control-group">
                                            <label class="control-label" for="typeahead">Album Name (<span style="color: red">*</span>) </label>
                                            <div class="controls">
                                                <input type="text" readonly class="span6 typeahead" id="typeahead" err="Enter a Valid Album Name"  data-provide="typeahead" data-items="4" name="album_name" required regexp="JSVAL_RX_ALPHA" value="<?php echo $photo_info->album_name; ?>">
                                                <input type="hidden" class="span6 typeahead" id="typeahead"  data-provide="typeahead" data-items="4" name="photo_id" value="<?php echo $photo_info->photo_id; ?>">
                                                <input type="hidden" class="span6 typeahead" id="typeahead"  data-provide="typeahead" data-items="4" name="album_id" value="<?php echo $photo_info->album_id; ?>">
                                        ...
                                        <div class="control-group">
                                            <br>
                                            <?php
                                            if ($photo_info->photo_image2) {
                                                ?>
                                                <div class="control-group">
                                                    <label class="control-label" for="fileInput"> Image</label>
                                                    <div class="controls">
                                                        <img style="width: 110px; height: 110px;" src="<?php echo base_url() . $photo_info->photo_image2; ?>">
                                                        <a href="<?php echo base_url(); ?>super_admin/delete_photo_image/<?php echo $photo_info->photo_id; ?>">delete image</a>
                                                    </div>
                                                </div>
                                            <?php } else { ?>
                                                <div class="control-group">
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <select name="photo_publication_status" id="publication_status" err="Please Select Publication Status" required exclude=" ">
    ...
    <script type="text/javascript">
        document.forms['update_photo_info_content'].elements['publication_status'].value = '<?php echo $photo_info->photo_publication_status; ?>';
    </script>
    <!-- jQuery -->
