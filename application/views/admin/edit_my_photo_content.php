        ...
        <aside class="right-side">                
            ...
            <section class="content-header">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="active">Edit My Photo</li>
                </ol>
            </section>
                    ...
                    <div class="row-fluid sortable">
                        <div class="box span12">
                            <div class="box-content">
                                <form class="form-horizontal" enctype="multipart/form-data" action="<?php echo base_url(); ?>super_admin/update_my_photo" method="post" >
                                    <fieldset>
                                        <legend>Edit My Photo</legend>

                                        <div class="control-group">
                                                      <input type="hidden" class="span6 typeahead" id="typeahead"  data-provide="typeahead" data-items="4" name="admin_id" value="<?php echo $admin_info->admin_id; ?>">
                                            <?php
                                            if ($admin_info->admin_image2) {
                                                ?>
                                                <div class="control-group">
                                                    <label class="control-label" for="fileInput"> Image</label>
                                                    <div class="controls">
                                                        <img style="width: 110px; height: 110px;" src="<?php echo base_url() . $admin_info->admin_image2; ?>">
                                                        <a href="<?php echo base_url(); ?>super_admin/delete_my_image/<?php echo $admin_info->admin_id; ?>">delete image</a>
                                                    </div>
                                                </div>
                                            <?php } else { ?>
                                                <div class="control-group">
                                                    ...
                                                    <div class="controls">
                                                        <input class="input-file uniform_on" id="fileInput" type="file" name="admin_image1">
                                                    </div>
                                                </div>
                                            <?php } ?>
                                        </div>
